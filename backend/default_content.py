"""Default site content — mirrors the DEFAULT_CONTENT from frontend/src/mock.js.
Used to seed MongoDB on first API call."""
...
DEFAULT_CONTENT = {
    ...
    "hero": {
        ...
        "subtitle": "Premium decorative, residential, commercial, and architectural lighting solutions — curated for homes, hotels, and finer spaces across Kerala.",
    ...
    "products": [
        {"id": "p1", "name": "Aurora Crystal Chandelier", "category": "chandeliers", "price": 42500,
         ...
         "featured": True},
        {"id": "p2", "name": "Milano Brass Pendant", "category": "pendant", "price": 8900,
         ...
         "featured": True},
        {"id": "p3", "name": "Halo LED Panel 24W", "category": "led", "price": 1450,
         ...
         "featured": True},
        {"id": "p4", "name": "Onyx Wall Sconce Pair", "category": "wall", "price": 3600,
         ...
         "featured": True},
        {"id": "p5", "name": "Garden Bollard Copper", "category": "garden", "price": 4900,
         ...
         "featured": True},
        {"id": "p6", "name": "Nova Smart Ceiling", "category": "smart", "price": 12800,
         ...
         "featured": True},
        {"id": "p7", "name": "Beam Track Spot 3-head", "category": "spot", "price": 5400,
         ...
         "featured": False},
        {"id": "p8", "name": "Terrace Floodlight 100W", "category": "outdoor", "price": 6200,
